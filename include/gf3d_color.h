//COPIED FROM GF2D PROJECT. NOT MY OWN CODE//

#ifndef __GF3D_COLOR_H__
#define __GF3D_COLOR_H__
...
#define gf3d_color_copy(dst,src) (dst.r = src.r,dst.g = src.g,dst.b = src.b,dst.a = src.a,dst.ct = src.ct)
...
/**
 * @brief convert a SDL color to gf3d floating point representation
 * @param color the color to convert
 * @return a new color in the format CT_RGBAf
 */
...
/**
 * @brief convert a gf3d color to SDL color format
 * @param color the color to convert
